...
func (o *Optional) Missing() bool { return !o.present }

// SetMissing sets the structs missing status. true means missing and false
// means present.
func (o *Optional) SetMissing(missing bool) { o.present = !missing }
...
func (o *OptionalInt16) Get() (int16, bool) { return o.val, o.present }
...
// Get returns the value and a boolean indicating if the value is present.
func (o *OptionalInt32) Get() (int32, bool) { return o.val, o.present }
...
// Get returns the value and a boolean indicating if the value is present.
func (o *OptionalInt64) Get() (int64, bool) { return o.val, o.present }
...
// Get returns the value and a boolean indicating if the value is present.
func (o *OptionalFloat32) Get() (float32, bool) { return o.val, o.present }
...
// Get returns the value and a boolean indicating if the value is present.
func (o *OptionalFloat64) Get() (float64, bool) { return o.val, o.present }
